...
import { schedulingThread, freshGreeting, replayHighlights } from '../../../coach/seed'
...
export default function AICoaching() {
  ...
  const [messages, setMessages] = useState<Message[]>(schedulingThread)
  const [highlights, setHighlights] = useState<Highlights>(replayHighlights(schedulingThread()))
